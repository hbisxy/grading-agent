...
const testQuestion = "Explain the water cycle and its importance to Earth's ecosystems.";
...
async function testAnalysis() {
  ...
  try {
    ...
    data.highlights.forEach((highlight, idx) => {
      ...
      console.log(`   Text: "${testContent.substring(highlight.start, highlight.end)}"`);
    });

    console.log("\n📝 Suggested Grades:");
    Object.entries(data.suggestedGrades || {}).forEach(([criterionId, grade]) => {
